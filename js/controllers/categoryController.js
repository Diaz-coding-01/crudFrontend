...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function loadCategories() {
        try{
            ...
            tableBody.innerHTML = ''; //Vaciamos el body
            ...
            categories.forEach((cat) => {
                ...
                //Funcionalidad de botón para editar categoría
                ...
                tr.querySelector(".delete-btn").addEventListener("click", async () => {
                    if(confirm("¿Desea elimina la categoría?")){
                        await deleteCategory(cat.idCategoria);
                        await loadCategories();
                    }
                });
                tableBody.appendChild(tr); //Al tbody se agrega el tr creado
            });
        } catch(err){
